...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>      
		...
		<div class="field">
			...
			<input type="text" id="name" name="name" placeholder="<?php echo $_POST['name']; ?>" />

			<label for="email">Student Email:</label>
			<input type="text" id="email" name="email" placeholder="<?php echo $_POST['email']; ?>" />
